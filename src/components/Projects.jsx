...
const projects = [
  {
    id: "01",
    name: "MERN Stack E-Commerce Web Application",
    role: "Full Stack Developer",
    description: "Developed a full-stack e-commerce platform using the MERN stack with secure JWT-based authentication and role-based access (Admin/User). Implemented key features like product listing, cart management, and order processing. Built an admin dashboard to manage users, orders, and update order statuses. Integrated RESTful APIs, ensured smooth state management, and enhanced user experience with responsive design and form validations while maintaining a clean and optimized code structure.",
    image: "/project05.jpg",
  },
  {
    id: "02",
